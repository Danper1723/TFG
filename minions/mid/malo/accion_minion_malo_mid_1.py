    ...
    def draw(self, win):
        ...
        if self.estado:
            ...
            if self.torre_mid_1_derecha and self.torre_mid_2_derecha and self.torre_mid_1_izquierda and self.torre_mid_2_izquierda:
                ...
                if self.x == 997 and self.y == 490 or self.x == 952 and self.y == 490:
