...
from minions.bot.bueno.accion_minion_bueno_bot_2 import Accion_minion_bueno_bot_2


class Img_minion_bueno_bot_2(Accion_minion_bueno_bot_2):
    ...
    for x in range(4):
        ...
        imgs2.append(pygame.image.load(os.path.join("..", "imagenes/minion2_alante", "2_enemies_1_run_0" + n + ".png")))
